...
import type { MoviesReturnData } from './+page.server';
...
describe('load function', () => {
  ...
  it('should fetch all movies when no query is provided', async () => {
    ...
    const result = await load({ fetch: mockFetch, url } as any) as MoviesReturnData;
  ...
  it('should handle API errors gracefully', async () => {
    ...
    expect(result.error).toBe('Es ist ein Fehler aufgetreten. Bitte versuchen Sie es später erneut.');
  });
